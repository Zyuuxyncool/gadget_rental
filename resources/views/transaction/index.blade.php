...
@php
// Ambil nilai tab dari query param, default 'belum-kembali'
...
<div class="transaction">
    ...
    <div class="transaction-header" style="display: flex; align-items: center; gap: 16px;">
        <form method="GET" action="{{ url()->current() }}" style="display: flex; align-items: center; gap: 8px; margin-bottom:0; color: var(--white);">
            <input type="hidden" name="tab" value="{{ $tab }}">
            <input
                type="date"
                name="tanggal"
                value="{{ request('tanggal', \Carbon\Carbon::now()->format('Y-m-d')) }}"
                style="height: 44px; color: var(--white); font-weight: 500; font-size: 16px; border: 1px solid var(--chocolate-brown); border-radius: 6px; padding: 6px 10px;">
